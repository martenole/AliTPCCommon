...
{
  fMemoryPermanent = mRec->RegisterMemoryAllocation(this, &AliGPUTRDTracker::SetPointersBase, AliGPUMemoryResource::MEMORY_PERMANENT, "Initialize");
  fMemoryTracklets = mRec->RegisterMemoryAllocation(this, &AliGPUTRDTracker::SetPointersTracklets, AliGPUMemoryResource::MEMORY_INPUT, "Tracklets");
  ...
  fMemoryTracks = mRec->RegisterMemoryAllocation(this, &AliGPUTRDTracker::SetPointersTracks, type, "Tracks");
}
...
GPUg() void DoTrdTrackingGPU()
{
  ...
  {
    gGPUConstantMem.trdTracker.DoTrackingThread(i, get_global_id(0));
  }
}
...
GPUd() void AliGPUTRDTracker::DoTrackingThread(int iTrk, int threadId)
{
  //--------------------------------------------------------------------
